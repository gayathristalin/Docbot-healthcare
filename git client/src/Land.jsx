...
const LandingPage = () => {
  return (
    <div className="landing-page">
      <header>
        <h1 className="landtitle">Welcome to Docbot</h1>
        <p>Find quick remedies for your problems</p>
        <br />
        <br />
        <p className="paraaaaa">
          Experience instant relief with our chat-based healthcare solution.
          Skip the waiting rooms and connect directly to personalized remedies.
          From symptoms to solutions, chat your way to wellness. Say goodbye to
          long waits and hello to instant relief. Your health journey starts
          here. Connect, chat, and cure with us today!
        </p>
      </header>
      <div class="buttons">
        <Link to="/signup">
